...
import {
  LayoutDashboard, Building2, Search, CheckSquare, PenTool,
  BarChart3, ShieldAlert, Bell, Settings, Users,
  ChevronDown, RotateCcw, type LucideIcon
} from 'lucide-react';
...
const navItems: { icon: LucideIcon; label: string; page?: PageId; hasChildren?: boolean }[] = [
  { icon: LayoutDashboard, label: 'Dashboard National', page: 'dashboard' },
  { icon: Building2, label: 'Institutions', page: 'institutions', hasChildren: true },
  { icon: Search, label: 'Registre National', page: 'registre', hasChildren: true },
  { icon: CheckSquare, label: 'Validation Ministérielle', page: 'validation', hasChildren: true },
  { icon: PenTool, label: 'Centre National de Signature', page: 'signature', hasChildren: true },
  { icon: BarChart3, label: 'Analytics National', hasChildren: true },
  { icon: ShieldAlert, label: 'Détection de Fraude', hasChildren: true },
  { icon: Bell, label: 'Notifications', hasChildren: true },
  { icon: Settings, label: 'Paramètres', page: 'parametres', hasChildren: true },
