...
const data = [
  { name: 'Approuvées', value: 156, color: '#10b981', pct: '76%' },
  { name: 'En révision', value: 20, color: '#f59e0b', pct: '10%' },
  { name: 'En attente', value: 10, color: '#3b82f6', pct: '7%' },
  { name: 'Rejetées', value: 10, color: '#ef4444', pct: '0%' },
  { name: 'Autres', value: 4, color: '#d1d5db', pct: '' },
];

export default function ValidationChart() {
  return (
    <div className="bg-white rounded-xl border border-gray-100 p-4">
      <h3 className="text-sm font-semibold text-gray-800 mb-3">Validation des formations</h3>
